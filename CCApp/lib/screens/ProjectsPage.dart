                          ...
                          itemBuilder: (context, index) {
                            return Slidable(
                              ...
                              child: ProjectCard(
                                ...
                                member1:
                                    projectDetails[index]['member1'] == null
                                        ? ''
                                        : projectDetails[index]['member1'],
                                member2:
                                    projectDetails[index]['member2'] == null
                                        ? ''
                                        : projectDetails[index]['member2'],
                                member3:
                                    projectDetails[index]['member3'] == null
                                        ? ''
                                        : projectDetails[index]['member3'],
                                member4:
                                    projectDetails[index]['member4'] == null
                                        ? ''
                                        : projectDetails[index]['member4'],
                                member5:
                                    projectDetails[index]['member5'] == null
                                        ? ''
                                        : projectDetails[index]['member5'],
                                member6:
                                    projectDetails[index]['member6'] == null
                                        ? ''
